...
// Додатковий функціонал - видкріття картінки!!!!!!!!
const tabHeaders = document.querySelectorAll("[data-tab]");
const contentImages = document.querySelectorAll("[data-tab-img]");
...
tabHeaders.forEach(function (item) {
  item.addEventListener("click", function () {
    ...
    const contentImage = document.querySelector("#" + this.dataset.tab);
    contentImage.classList.remove("visually-hidden");
  });
});
